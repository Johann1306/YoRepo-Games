...
public class WindowMP3 {
	...
	public static void main(String[] args) {
				...
				try {
					...
					if (application.isPlaying()) {
						...
						if (!t.isAlive()) {
							...
							System.out.println(t.getId() + ":" + t.getName() + " Alive :" + t.isAlive());
							System.out.println(t.getId() + ":" + t.getName() + "start");
							t.start();
							System.out.println(t.getId() + ":" + t.getName() + " Alive :" + t.isAlive());
		...
		pause.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				if (application != null ) {
				System.out.println("null ? " + application != null);
				System.out.println("isPlaying : " + application.isPlaying());
		...
		stop.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				// TODO : probleme du stop quand fini
				if (application != null && application.isPlaying()) {
					try {
						application.stop();
					} catch (Exception e1) {
