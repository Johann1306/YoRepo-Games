...
public class ActionCombatManager implements Serializable {
	...
	public void initialise() {
		...
		ActionCombat nicolasSort2 = new ActionCombat(incrementId(), "Sort 2", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.GROUPE_ALLIES, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat nicolasSpecial1 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat nicolasSpecial2 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		...
		ActionCombat pierreSort1 = new ActionCombat(incrementId(), "Soin 1", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.ALLIE, PersoStat.INTELLIGENCE, SortType.DEGATS_MONO);
		ActionCombat pierreSort2 = new ActionCombat(incrementId(), "Sort 2", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.GROUPE_ALLIES, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat pierreSpecial1 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat pierreSpecial2 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		...
		ActionCombat yannickSort1 = new ActionCombat(incrementId(), "Soin 1", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.ALLIE, PersoStat.INTELLIGENCE, SortType.DEGATS_MONO);
		ActionCombat yannickSort2 = new ActionCombat(incrementId(), "Sort 2", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.GROUPE_ALLIES, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat yannickSpecial1 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat yannickSpecial2 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		...
		ActionCombat thomasSort1 = new ActionCombat(incrementId(), "Soin 1", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.ALLIE, PersoStat.INTELLIGENCE, SortType.DEGATS_MONO);
		ActionCombat thomasSort2 = new ActionCombat(incrementId(), "Sort 2", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.GROUPE_ALLIES, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat thomasSpecial1 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat thomasSpecial2 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		...
		ActionCombat guillaumeSort1 = new ActionCombat(incrementId(), "Soin 1", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.ALLIE, PersoStat.INTELLIGENCE, SortType.DEGATS_MONO);
		ActionCombat guillaumeSort2 = new ActionCombat(incrementId(), "Sort 2", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.GROUPE_ALLIES, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat guillaumeSpecial1 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat guillaumeSpecial2 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		...
		ActionCombat aliSort1 = new ActionCombat(incrementId(), "Soin 1", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.ALLIE, PersoStat.INTELLIGENCE, SortType.DEGATS_MONO);
		ActionCombat aliSort2 = new ActionCombat(incrementId(), "Sort 2", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.GROUPE_ALLIES, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat aliSpecial1 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat aliSpecial2 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		...
		ActionCombat jonathanSort1 = new ActionCombat(incrementId(), "Soin 1", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.ALLIE, PersoStat.INTELLIGENCE, SortType.DEGATS_MONO);
		ActionCombat jonathanSort2 = new ActionCombat(incrementId(), "Sort 2", "abc", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.POUVOIR, EnergieType.MANA, CibleType.GROUPE_ALLIES, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat jonathanSpecial1 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		ActionCombat jonathanSpecial2 = new ActionCombat(incrementId(), "Debut de merde", "Fait un debut de merde mal maitrisé", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.SPECIAL, EnergieType.CHARGE, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
		
		// Boss1
		ActionCombat boss1Attaque1 = new ActionCombat(incrementId(), "Attaque 1", "attaque 1 info", imagePaths, sonPaths, videoPaths, disponible, niveau, niveauMax, progression, ActionCombatType.ATTAQUE, EnergieType.RIEN, CibleType.GROUPE_ENNEMIS, PersoStat.TECHNIQUE, SortType.DEGATS_MONO);
