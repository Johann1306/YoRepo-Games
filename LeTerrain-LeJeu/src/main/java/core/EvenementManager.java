...
//		Evenement film1 = new Evenement("Die Hard 3", "", "image/film/diehard3.jpg", "son/film/diehard3.mp3", videoPathNull, EvenementTheme.SORTIE_FILM, DateManager.genereUneDate(1995, Calendar.MAY, 15, 14, 0, 0), itemsDebloquesFilm1);
		...
		Evenement da4 = new Evenement("Tic et Tac - Les Rangers du Risque", "", imagePathda4, sonPathNull, videoPathda4, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1990, Calendar.NOVEMBER, 15, 10, 0, 0), null);
		...
		Evenement da10 = new Evenement("Captain Planet", "", imagePathda10, sonPathNull, videoPathda10, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1991, Calendar.MARCH, 1, 10, 0, 0), null);
		...
		Evenement da15 = new Evenement("Super Mario Bros", "", imagePathda15, sonPathNull, videoPathda15, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1991, Calendar.AUGUST, 1, 10, 0, 0), null);
