...
//		Evenement film1 = new Evenement("Die Hard 3", "", "image/film/diehard3.jpg", "son/film/diehard3.mp3", videoPathNull, EvenementTheme.SORTIE_FILM, DateManager.genereUneDate(1995, Calendar.MAY, 15, 14, 0, 0), itemsDebloquesFilm1);
		...
		Evenement da7 = new Evenement("Dragon Ball Z", "Merci Akira pour tout ce que tu as fait pour la planete", imagePathda7, sonPathNull, videoPathda7, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1990, Calendar.DECEMBER, 24, 10, 0, 0), null);
		...
		Evenement da10 = new Evenement("Captain Planet", "Quand l'ecologie etait encore fun", imagePathda10, sonPathNull, videoPathda10, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1991, Calendar.MARCH, 1, 10, 0, 0), null);
		...
		Evenement da15 = new Evenement("Super Mario Bros", "Generique de fin : premiere prise ... Coupez! Elle est bonne!", imagePathda15, sonPathNull, videoPathda15, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1991, Calendar.AUGUST, 1, 10, 0, 0), null);
		...
		Evenement da26 = new Evenement("Les Aventures de Sonic", "J'ai failli attendre!", imagePathda26, sonPathNull, videoPathda26, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1993, Calendar.FEBRUARY, 1, 10, 0, 0), null);
		...
		Evenement da29 = new Evenement("Les Histoires du père Castor", "Peut-on avoir un dragon chez soi?", imagePathda29, sonPathNull, videoPathda29, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1993, Calendar.APRIL, 22, 10, 0, 0), null);
...
//		Evenement da37 = new Evenement("Power Rangers", "", imagePathda37, sonPathNull, videoPathda37, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1994, Calendar.APRIL, 13, 10, 0, 0), null);
		...
		Evenement da39 = new Evenement("Gargoyles", "Epic generic", imagePathda39, sonPathNull, videoPathda39, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1995, Calendar.JULY, 1, 10, 0, 0), null);
		...
		Evenement da46 = new Evenement("South Park", "M'voyez", imagePathda46, sonPathNull, videoPathda46, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1998, Calendar.JULY, 17, 10, 0, 0), null);
		Evenement da47 = new Evenement("Batman", "Epic generic", imagePathda47, sonPathNull, videoPathda47, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1992, Calendar.SEPTEMBER, 5, 10, 0, 0), null);
		...
		Evenement da50 = new Evenement("Le retour de Léo", "La version originale pompee par Disney", imagePathda50, sonPathNull, videoPathda50, EvenementTheme.SORTIE_DESSIN_ANIME, DateManager.genereUneDate(1990, Calendar.SEPTEMBER, 17, 10, 0, 0), null);
	
		// Dessins Animes 80 (10 ans)
		// TODO Goldorak? Barbapapa? Creamy?
		Evenement da101 = new Evenement("Il était une fois... l'Homme", "Le generique avec la fin la plus traumatisante de l'Histoire", imagePathda101, sonPathNull, videoPathda101, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1990, Calendar.OCTOBER, 2, 10, 0, 0), null);
		Evenement da102 = new Evenement("Albator", "Ah l'batard", imagePathda102, sonPathNull, videoPathda102, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1990, Calendar.DECEMBER, 7, 10, 0, 0), null);
		...
		Evenement da107 = new Evenement("Bouba", "Le ptit ourson", imagePathda107, sonPathNull, videoPathda107, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1991, Calendar.DECEMBER, 21, 10, 0, 0), null);
		...
		Evenement da112 = new Evenement("Tom Sawyer", "Le gitan d'amerique", imagePathda112, sonPathNull, videoPathda112, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1992, Calendar.DECEMBER, 13, 10, 0, 0), null);
		Evenement da113 = new Evenement("Les Schtroumpfs", "A 30 pour 1", imagePathda113, sonPathNull, videoPathda113, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1992, Calendar.DECEMBER, 27, 10, 0, 0), null);
		...
		Evenement da115 = new Evenement("Les Mystérieuses Cités d'or", "Enfants du soleil", imagePathda115, sonPathNull, videoPathda115, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1993, Calendar.SEPTEMBER, 28, 10, 0, 0), null);
		Evenement da116 = new Evenement("Téléchat", "C'etait pour les gosses ca?", imagePathda116, sonPathNull, videoPathda116, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1993, Calendar.OCTOBER, 3, 10, 0, 0), null);
		Evenement da117 = new Evenement("Inspecteur Gadget", "Gogo gadget", imagePathda117, sonPathNull, videoPathda117, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1993, Calendar.OCTOBER, 24, 10, 0, 0), null);
		...
		Evenement da120 = new Evenement("Les Minipouss", "Le generique ou tu comprends pas les paroles", imagePathda120, sonPathNull, videoPathda120, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1994, Calendar.NOVEMBER, 2, 10, 0, 0), null);
...
//		Evenement da129 = new Evenement("Blondine", "", imagePathda129, sonPathNull, videoPathda129, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1995, Calendar.SEPTEMBER, 9, 10, 0, 0), null);
		...
		Evenement da138 = new Evenement("Pingu", "Moi je comprenais tout", imagePathda138, sonPathNull, videoPathda138, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1996, Calendar.JULY, 2, 10, 0, 0), null);
		...
		Evenement da140 = new Evenement("Mimi Cracra", "La p'tite crasseuse", imagePathda140, sonPathNull, videoPathda140, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1996, Calendar.MAY, 2, 10, 0, 0), null);
		...
		Evenement da156 = new Evenement("SOS Fantômes", "C'est du slim", imagePathda156, sonPathNull, videoPathda156, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1997, Calendar.APRIL, 2, 10, 0, 0), null);
		Evenement da157 = new Evenement("L'Anglais avec Victor", "Best animation ever", imagePathda157, sonPathNull, videoPathda157, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1997, Calendar.MAY, 2, 10, 0, 0), null);
		Evenement da158 = new Evenement("Il était une fois... la Vie", "Les petits Sarko dans ton corps", imagePathda158, sonPathNull, videoPathda158, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1997, Calendar.JANUARY, 15, 10, 0, 0), null);
		...
		Evenement da160 = new Evenement("Les Ewoks", "Les derives de star wars", imagePathda160, sonPathNull, videoPathda160, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1997, Calendar.JANUARY, 8, 10, 0, 0), null);
		...
		Evenement da164 = new Evenement("Rahan", "Fils des ages farouches", imagePathda164, sonPathNull, videoPathda164, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1997, Calendar.NOVEMBER, 29, 10, 0, 0), null);
		Evenement da165 = new Evenement("Les Tortues Ninja", "Krang et le technodrome", imagePathda165, sonPathNull, videoPathda165, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.FEBRUARY, 2, 10, 0, 0), null);
		Evenement da166 = new Evenement("Club BCBG", "La voiture piscine", imagePathda166, sonPathNull, videoPathda166, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.MARCH, 2, 10, 0, 0), null);
		...
		Evenement da168 = new Evenement("Lucile, Amour et Rock'n Roll", "Ca c'etait de la merde", imagePathda168, sonPathNull, videoPathda168, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.JANUARY, 15, 10, 0, 0), null);
...
//		Evenement da170 = new Evenement("Alf", "", imagePathda170, sonPathNull, videoPathda170, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.MARCH, 18, 10, 0, 0), null);
		Evenement da171 = new Evenement("Les Chevaliers du Zodiaque", "Les poings de Pegase", imagePathda171, sonPathNull, videoPathda171, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.APRIL, 6, 10, 0, 0), null);
		...
		Evenement da173 = new Evenement("Georgie", "Elle mourra ecrasee par une voiture a la fin", imagePathda173, sonPathNull, videoPathda173, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.AUGUST, 29, 10, 0, 0), null);
		Evenement da174 = new Evenement("Lamu", "Trop de vetement pour un enfant", imagePathda174, sonPathNull, videoPathda174, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.AUGUST, 30, 10, 0, 0), null);
		Evenement da175 = new Evenement("Ken le Survivant", "La patate a ... Ken", imagePathda175, sonPathNull, videoPathda175, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.AUGUST, 31, 10, 0, 0), null);
		Evenement da176 = new Evenement("Docteur Slump", "Les debuts d'Akira", imagePathda176, sonPathNull, videoPathda176, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.SEPTEMBER, 4, 10, 0, 0), null);
		Evenement da177 = new Evenement("Olive et Tom", "Captain Tsubasa mal traduit", imagePathda177, sonPathNull, videoPathda177, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.SEPTEMBER, 6, 10, 0, 0), null);
		Evenement da178 = new Evenement("Galaxy Express 999", "Ca rock", imagePathda178, sonPathNull, videoPathda178, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1998, Calendar.SEPTEMBER, 11, 10, 0, 0), null);
		...
		Evenement da180 = new Evenement("Pif et Hercule", "De memoire c'etait le chat l'encule", imagePathda180, sonPathNull, videoPathda180, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1999, Calendar.OCTOBER, 9, 10, 0, 0), null);
		...
		Evenement da183 = new Evenement("Dino-Riders", "Des dinosaures du passe et des lasers du futur!!!", imagePathda183, sonPathNull, videoPathda183, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1999, Calendar.APRIL, 26, 10, 0, 0), null);
		Evenement da184 = new Evenement("But pour Rudy", "Dur de concurencer Olive et Tom a cette epoque", imagePathda184, sonPathNull, videoPathda184, EvenementTheme.SORTIE_DESSIN_ANIME_10ANS, DateManager.genereUneDate(1999, Calendar.SEPTEMBER, 10, 10, 0, 0), null);
