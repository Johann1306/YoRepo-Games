...
public class Lieu extends Item implements Serializable {
	...
	public Lieu(int id, String nom, String informations, List<String> imagePaths, List<String> sonPaths,
			List<String> videoPaths, PersoPrenom proprietaire, Point position, String backgroundPath, List<Poi> pois,
